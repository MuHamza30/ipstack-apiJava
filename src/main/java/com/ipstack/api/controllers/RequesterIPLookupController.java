 ...
 */
public final class RequesterIPLookupController extends BaseController {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public RequesterIPLookupController(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }

    /**
     * The ipstack API also offers a separate API endpoint capable of detecting the IP address which
     * the current API request is coming from. In order to use this endpoint, simply append `check`
     * to the API's base URL and specify your preferred optional parameters. Note: The Requester IP
     * Lookup endpoint returns the details of the IP address from where the request is coming from.
     * For example, if you make a request from the Postman web app, it will show the details of the
     * Postman server, but if you make a request from the Postman client app, it will show the
     ...
     */
    public IPLocation getRequesterIPLookup(
        ...
        return prepareGetRequesterIPLookupRequest(accessKey, hostname, callback, language, fields,
                output).execute();
    }
     ...
     * @return    Returns the IPLocation response from the API call
     */
    public CompletableFuture<IPLocation> getRequesterIPLookupAsync(
            final String accessKey,
            final HostnameEnum hostname,
            final String callback,
            final Language1Enum language,
    ...
    /**
     * Builds the ApiCall object for getRequesterIPLookup.
     */
    private ApiCall<IPLocation, ApiException> prepareGetRequesterIPLookupRequest(
            final String accessKey,
            final HostnameEnum hostname,
            final String callback,
            final Language1Enum language,
